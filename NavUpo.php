            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/Evidence_Izposojenega_Gradiva/posiljanjeobvestila.php">Sporočila</a></li>
                        <li class="nav-item"><a class="nav-link" href="/Evidence_Izposojenega_Gradiva/profiluredi.php">Spremeni geslo</a></li>
